...
import ServiceStatics from "../../components/services/serviceStatics/ServiceStatics";
      ...
      <section className="services-about" id="services">
        <Container>
          ...
          <div className="serviceCardSection">
            <h2 className="serviceCardHeading">Missiyamız</h2>
            <img src={vector} alt="vector" className="vector" />
            <Row>
              <Col>
